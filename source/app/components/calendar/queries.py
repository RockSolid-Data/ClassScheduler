...
CALENDAR_EVENTS_QUERY = (
    ...
    "  ) AS events_html\n"
    "FROM days d\n"
    "LEFT JOIN class_scheduler.trainingsession ts\n"
...
SERVICE_APPOINTMENTS_QUERY = (
    ...
    "  ) AS events_html\n"
    "FROM days d\n"
    "LEFT JOIN class_scheduler.serviceappointment sa\n"
...
EMPLOYEE_CONTRACTS_QUERY = (
    ...
    "  ) AS events_html\n"
    "FROM days d\n"
    "LEFT JOIN class_scheduler.employeecontract ec\n"
    ...
    "  )\n"
    "LEFT JOIN class_scheduler.employee e\n"
